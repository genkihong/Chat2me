...
//首頁-熱門即時看板(未登入)
export const apiPopularForumList = () => http.get('/forum/popular')
//首頁-使用者最近造訪看版(已登入)
...
//追蹤看板
export const apiFollowForum = (data) => http.post('/forum/follow', data)
//取消追蹤
export const apiDelFollowForum = (id) => http.delete(`/forum/follow/${id}`)
